...
export const EVENT_TYPE_COLORS: Record<CaseEventType, string> = {
  status_change: 'bg-blue-500',
  hearing: 'bg-green-500',
  document_upload: 'bg-purple-500',
  ruling: 'bg-orange-500',
  assignment: 'bg-cyan-500',
  note: 'bg-gray-500',
  party_change: 'bg-indigo-500'
};

// Event type icons
export const EVENT_TYPE_ICONS: Record<CaseEventType, string> = {
