...
import { CaseVerificationCard } from '@/components/clerk/CaseCard';
...
export default function ClerkCases() {
  ...
  const handleCreateCase = () => {
    router.push('/clerk/cases/create');
  };

  const handleViewCase = (caseId: string) => {
    router.push(`/clerk/cases/${caseId}`);
  };
        ...
        <Card className="w-full max-w-md">
          <CardContent className="pt-6">
            <div className="text-center">
              <ArrowLeft className="mx-auto h-12 w-12 text-red-500" />
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">
              Create and manage case filings.
            </p>
          </div>
      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex gap-2">
          <Button
            ...
            onClick={() => router.push('/clerk/cases?filter=all')}
          >
            All Cases
          </Button>
          <Button
          ...
          <Button
            ...
            onClick={() => router.push('/clerk/cases?filter=verified')}
          >
            Verified
          </Button>
        </div>
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>
                      {caseItem.caseNumber} • Filed on {new Date(caseItem.createdAt).toLocaleDateString()}
                    </CardDescription>
                  </div>
